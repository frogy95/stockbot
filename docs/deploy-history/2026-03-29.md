...
| 서비스 | URL |
|--------|-----|
| 프론트엔드 (Vercel) | https://stockbot.choiji.kr (커스텀) / https://stockbot-blush.vercel.app |
| 백엔드 (Railway) | https://api.stockbot.choiji.kr (커스텀) / https://stockbot-production-6a39.up.railway.app |
| Swagger UI | https://api.stockbot.choiji.kr/docs |
...
- **Cloudflare**: DNS 관리 (choiji.kr, stockbot → Vercel CNAME, api.stockbot → Railway CNAME)

...
| 7 | ~~`_premarket_retry` 재시도 성공 후 cross_check_prices 호출 누락~~ | ~~⚠️ Medium~~ | - | ✅ 해결 — scheduler.py line 598-604에서 `_premarket_retry` 성공 시 cross_check_prices 호출 이미 구현됨 (2026-04-06 확인) |

...
- [Phase 8.6 Sprint 5 축소 재설계](project_phase8.6-sprint5.md) — 2026-05-14, 직전 8 Task plan 사용자 거부, **3 Task / 3~5일** 축소(T1 코드 즉답 #7/#8/#9/#11 + T2 DB/백테스트 #10/#13/#14 + T3 라이브 trace #6 Paper 1주 병행), entry gate 10→**3개**(E1 WS 누락률 ≤5% / E2 fallback 비중 ≤20% / G-Bt1+G-Bt2), 기존 E3~E10은 Task 종료 조건으로 흡수, Hotfix A/B 즉시 분리 + 조건부 Hotfix C(#9 G3 부등호), Sprint 6 placeholder 삭제, 전문가 4명 재호출 X, 핵심 원칙=과거 데이터로 답 나오는 것을 미래 관찰로 미루지 말 것

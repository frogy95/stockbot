...
5. **Medium 이슈 → 미해결 사항 추가**: 코드 리뷰에서 발견된 Medium 이슈를 Phase 문서의 미해결 사항 테이블에 추가. sprint-planner가 다음 Sprint 계획 시 참조할 수 있도록 "Sprint {N+1}에서 개선 권장" 표기

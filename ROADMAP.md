...
- 현재 Sprint: **Phase 8.6 Sprint 1 — 계획 수립 완료, 구현 착수 대기** (`docs/phase/phase8.6/sprint1/sprint1.md`, 7 Task) — 선행 패치(분기 D 손실 차단) + DoR 가드레일 G1~G3 동시 구축
...
### 범위 (4 Sprint, 3~4주)
- **Sprint 1** 🔄 — 선행 패치 + DoR 가드레일 (PO Sprint 2.6 흡수): M-F2 산출(G1), 자동 롤백 R1~R4 다변화(G2), 1차→2차 회로차단기(G3), 폴백 5종 확장, min_volume_floor 시간대 슬라이딩 0.3(09~11시), Phase 7.0 LIVE 파라미터 코드 잠금 — `docs/phase/phase8.6/sprint1/sprint1.md` (7 Task, 계획 수립 완료 2026-04-29)

...
- 현재 Sprint: Phase 2 Sprint 2 (종목 스크리닝 엔진) 📋 예정
- 완료된 스프린트: Phase 0.5 Sprint 1 (2026-03-29), Phase 1 Sprint 1 (2026-03-29), Phase 1 Sprint 2 (2026-03-29), Phase 2 Sprint 1 (2026-03-29)
- 프로덕션 배포: v0.1.0 (2026-03-29) — Vercel + Railway
- 다음 마일스톤: Phase 2 Sprint 2 — 종목 스크리닝 엔진 (1차/2차 스크리닝 + 팩터 스코어링)

...
- 현재 Sprint: **Phase 8.6 Sprint 2 — 🔄 진행 중** (`docs/phase/phase8.6/sprint2/sprint2.md` v2, 2026-04-29 4명 리뷰 합의 반영 갱신, 구현 대기) — 병렬 OR tier 분리 + ATR 분위수 캘리브레이션 + 시뮬-실측 절대차 + Kill-switch 런북 (6 Task)
